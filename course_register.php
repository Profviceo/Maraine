...
<div class="wrapper">
	<section class="form">
	<form method="POST" action="includes/course_register.inc.php">
		<h1>Course Registration Page</h1><br>
		<label>Course One</label><br><input type="text" name="course_1" placeholder="Course 1" ><br>
		<label>Course Two</label><br><input type="text" name="course_2"  placeholder="Course 2"><br>
		<label>Course Three</label><br><input type="text" name="course_3" placeholder="Course 3"><br>
		<label>Course Four</label><br><input type="text" name="course_4" placeholder="Course 4"><br>
