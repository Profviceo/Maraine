	...
	<div class="container">
		...
		<div class="container_2">
			...
			<?php
				...
				}elseif ($signup == "nameerror") {
					echo '<p class="error">Please make sure your full name is inputed with no character . It should be inputed with a space between.(John Doe)</p>';
				}elseif ($signup == "usernameinvalid") {
					echo '<p class="error">Your username can only have characters like [a-z,A-Z,0-9]</p>';
				}elseif($signup == "invalidphone"){
					echo '<p class="error">Your Phone Number is invalid. Please type in a valid Nigerian Phone Number</p>';
				}elseif($signup == "invalidemail"){
					echo '<p class="error">Your Email Input is invalid</p>';
				}elseif ($signup == "passwordnotmatch") {
					echo '<p class="error">Your password does not match</p>';
				}elseif ($signup == "lesspass") {
					echo '<p class="error">Your password must not be lesser than 8 characters or higher than 21 characters </p>';
				}elseif ($signup == "passnochar") {
					echo '<p class="error">Your password must contain one or more characters</p>';
				}elseif ($signup == "invalidstate") {
					echo '<p class="error">You must choose a Nigerian State to continue</p>';
				}elseif ($signup == "invaliddate") {
					echo '<p class="error">You must be older than 18 to continue</p>';
				}elseif ($signup == "usernameused") {
					echo '<p class="error">The username has been used</p>';
				}elseif ($signup == "emailused") {
					echo '<p class="error">The email has been used</p>';
				}elseif ($signup == "phoneused") {
					echo '<p class="error">The phone number has been used</p>';
				}
			}
			?>
			<form method="POST" action="includes/signup.inc.php" >
				...
				<?php
					...
					if (!isset($_GET['Fullname'])) {
						...
						echo '<input type="text" name="Fullname" placeholder="Full Name" value="'.$Fullname.'"><br>';
					}
				 ?>
				...
				<?php
					...
					if (!isset($_GET['useremail'])) {
						echo '<input type="email" name="useremail" placeholder="Your Email"><br>';
					}else{
						$useremail = $_GET['useremail'];
						echo '<input type="email" name="useremail" placeholder="Your Email" value="'.$useremail.'"><br>';
					}
				 ?>
				...
				<?php
					...
					if (!isset($_GET['Phone'])) {
						...
						$Phone = $_GET['Phone'];
						echo '<input type="text" name="Phone" placeholder="Phone Number" value="'.$Phone.'"><br>';
					}
				 ?>
				...
				<?php
					...
					if (!isset($_GET['StateOrigin'])) {
						echo '<input list="state" name="StateOrigin" placeholder="State Of Origin"><br>
				<datalist id="state">
					<option>Abia</option>
					...
					<option>Zamfara</option>
						...
						echo '<input list="state" name="StateOrigin" placeholder="State Of Origin" value="'.$StateOrigin.'"><br>
				<datalist id="state">
					<option>Abia</option>
					<option>Adamawa</option>
					<option>Akwa Ibom</option>
				...
				<input type="password" name="confirm" placeholder="Type in your password again"><br>
